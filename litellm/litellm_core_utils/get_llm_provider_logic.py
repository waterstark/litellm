        ...
        if api_base:
            for endpoint in litellm.openai_compatible_endpoints:
                if endpoint in api_base:
                    ...
                    elif endpoint == "https://api.aimlapi.com/v2":
                        custom_llm_provider = "aiml"
                        dynamic_api_key = get_secret_str("AIML_API_KEY")
...
def _get_openai_compatible_provider_info(  # noqa: PLR0915
    ...
    if custom_llm_provider == "perplexity":
        ...
        api_base = api_base or get_secret("AIML_API_BASE") or "https://api.aimlapi.com/v2"  # type: ignore
        ...
        (
            ...
            api_base,
            dynamic_api_key,
        ) = litellm.FireworksAIConfig()._get_openai_compatible_provider_info(model, api_base, api_key)
        ...
        api_base = api_base or get_secret_str("VOYAGE_API_BASE") or "https://api.voyageai.com/v1"  # type: ignore
        ...
        api_base = api_base or get_secret("FRIENDLI_API_BASE") or "https://inference.friendli.ai/v1"  # type: ignore
